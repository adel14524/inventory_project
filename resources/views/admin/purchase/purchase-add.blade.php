                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Add Purchases</h4><br><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        ...
                                        <input class="form-control example-date-input" name="purchase_no" type="text" id="purchase_no" placeholder="Enter Purchase No">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="md-3 mt-4">
                                        ...
                                        <i class="btn btn-secondary waves-effect waves-light fas fa-plus-circle addeventmore"> Add More</i>
                                    </div>
                                </div>
                            </div> <!-- // end row  -->
                        </div> <!-- End card-body -->
